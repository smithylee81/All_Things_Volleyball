...
## As a visitor to the website, I want to know what I can do on the website, navigate with ease using a clearly defined navigation bar, understand how to register an account and be able to see social media links to be able to contact & communicate with the developer (a family member).
...
- Ensure Cards and Modals **(Bootstrap VERSION?)** are presented appropriately on all viewports:
